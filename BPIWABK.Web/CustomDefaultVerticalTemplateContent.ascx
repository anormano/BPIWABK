<%@ Control Language="C#" CodeBehind="CustomDefaultVerticalTemplateContent.ascx.cs" ClassName="CustomDefaultVerticalTemplateContent" Inherits="BPIWABK.Web.CustomDefaultVerticalTemplateContent" %>
...
<%@ Register Assembly="DevExpress.ExpressApp.Web.v17.2, Version=17.2.8.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.ExpressApp.Web.Templates.ActionContainers"
    TagPrefix="xaf" %>
<%@ Register Assembly="DevExpress.ExpressApp.Web.v17.2, Version=17.2.8.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.ExpressApp.Web.Templates"
    TagPrefix="xaf" %>
<%@ Register Assembly="DevExpress.ExpressApp.Web.v17.2, Version=17.2.8.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.ExpressApp.Web.Controls"
    TagPrefix="xaf" %>
<%@ Register Assembly="DevExpress.ExpressApp.Web.v17.2, Version=17.2.8.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.ExpressApp.Web.Templates.Controls"
    TagPrefix="xaf" %>
...
<style>
    ...
    .dxGridView_gvHeaderSortDown_XafTheme {
    ...
    .dxGridView_gvHeaderFilter_XafTheme {
