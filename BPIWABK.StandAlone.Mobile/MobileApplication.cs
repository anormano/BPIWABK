...
namespace BPIWABK.StandAlone.Mobile {
    // For more typical usage scenarios, be sure to check out https://documentation.devexpress.com/eXpressAppFramework/DevExpressExpressAppWebWebApplicationMembersTopicAll.aspx
    public partial class StandAloneMobileApplication : MobileApplication {
        ...
        private BPIWABK.StandAlone.Module.Mobile.StandAloneMobileModule module4;
        ...
        static StandAloneMobileApplication() {
        ...
        #endregion
        public StandAloneMobileApplication() {
        ...
        private void StandAloneMobileApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module4 = new BPIWABK.StandAlone.Module.Mobile.StandAloneMobileModule();
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.StandAloneMobileApplication_DatabaseVersionMismatch);
