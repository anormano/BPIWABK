...
namespace BPIWABK.Win {
    ...
    public partial class BPIWABKWindowsFormsApplication : WinApplication {
        #region Default XAF configuration options (https://www.devexpress.com/kb=T501418)
        static BPIWABKWindowsFormsApplication() {
        ...
        #endregion
        public BPIWABKWindowsFormsApplication() {
            InitializeComponent();
			InitializeDefaults();
        }
        ...
        private void BPIWABKWindowsFormsApplication_CustomizeLanguagesList(object sender, CustomizeLanguagesListEventArgs e) {
