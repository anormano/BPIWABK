...
namespace BPIWABK.Module.BusinessObjects.Reference
{
    ...
    [DefaultProperty("NamaJabatan")]
    //[DefaultListViewOptions(MasterDetailMode.ListViewOnly, false, NewItemRowPosition.None)]
    //[Persistent("DatabaseTableName")]
    // Specify more UI options using a declarative approach (https://documentation.devexpress.com/#eXpressAppFramework/CustomDocument112701).
    public class Jabatan : XPLiteObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public Jabatan(Session session)
            : base(session)
        {
        }
        ...
        {
            get => namaJabatan;
            set => SetPropertyValue(nameof(NamaJabatan), ref namaJabatan, value);
        }
        string keterangan;
